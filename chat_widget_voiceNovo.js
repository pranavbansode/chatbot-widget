// Chat Widget Script with Voice Input
(function() {
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                ...
                <button class="voice-button" title="Hold to record voice message">
    ...
    async function sendVoiceMessage(audioBlob) {
        ...
        // Append the voice data and message data
    ...
    // Alternative: Hold to record functionality (uncomment if preferred)
    /*
